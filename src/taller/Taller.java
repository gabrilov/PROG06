...
/**
 * Esta clase implementa los métodos que se emplean para interactuar con el
 * usuario, solicitando datos o imprimiendo mensajes con un formato determinado.
 * 
...
class Interaccion {
    ...
    /**
     * Pide un texto al usuario, que no puede quedar vacío.
     *
     * @param mensaje Mensaje con el que se le informa al
     *                usuario del dato que pedimos.
     * @return Devuelve el texto que ha introducido
     *         el usuario.
     */
    ...
    /**
     * Pide al usuario que introduzca una matrícula.
     *
     * @return Devuelve un objeto Matricula.
     */
    static Matricula pedirMatricula() {
        ...
        while (!hayValidacion) {
            String texto = pedirUnTexto(
                    "Introduce la matrícula del vehículo (ej. 1234BCD):").toUpperCase();
            try {
     ...
     *                el dato. Se realizan dos validaciones: si el dato introducido
     *                no es de
     *                tipo int, o si el valor no está dentro de los márgenes pasados
     *                en los
     *                parámetros, no se valida el dato y se solicita al usuario que
     *                lo
     *                introduzca de nuevo.
